...
from onpolicy.algorithms.graph_base_control_actor_critic import GR_Base_Actor, GR_Base_Critic
from onpolicy.utils.util import update_linear_schedule


class GR_BASE_MAPPO_Policy:
    """
    BASE MAPPO Policy class with proportional controller.
    Wraps actor and critic networks to compute actions and value function predictions.

    Actions are computed as: u = u_base + u_gnn
    - u_base = K_p * (goal - position): proportional baseline controller
