...
from onpolicy.algorithms.mad_mlp_critic_actor_critic import MAD_MLP_Critic
from onpolicy.utils.util import update_linear_schedule


class MAD_MLP_Critic_MAPPOPolicy:
    """
    MAD policy with the standard graph-based MAD actor and a centralized MLP
    critic
    """
