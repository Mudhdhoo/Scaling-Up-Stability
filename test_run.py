...
def main(args):
    ...
    total_params = sum(p.numel() for p in runner.policy.actor.parameters())
    print(f"Total actor parameters: {total_params}")

    total_params = sum(p.numel() for p in runner.policy.critic.parameters())
    print(f"Total critic parameters: {total_params}")
